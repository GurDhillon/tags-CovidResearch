...
DROP VIEW IF EXISTS RecentDates CASCADE;
DROP VIEW IF EXISTS RecentVaccination CASCADE;
DROP VIEW IF EXISTS ProportionVaccinated CASCADE;
DROP VIEW IF EXISTS q2;

DROP VIEW IF EXISTS VaccinationCountries CASCADE;
DROP VIEW IF EXISTS RefDates CASCADE;
DROP VIEW IF EXISTS WealthyCountries CASCADE;
DROP VIEW IF EXISTS WealthyVaccinations CASCADE;
DROP VIEW IF EXISTS WealthyEarlier CASCADE;
DROP VIEW IF EXISTS WealthyMaxDate CASCADE;
DROP VIEW IF EXISTS WealthyRecent CASCADE;
DROP VIEW IF EXISTS WealthyTotal CASCADE;
DROP VIEW IF EXISTS WealthyPopulation CASCADE;
DROP VIEW IF EXISTS WealthyProportion CASCADE;
DROP VIEW IF EXISTS PoorCountries CASCADE;
DROP VIEW IF EXISTS PoorVaccinations CASCADE;
DROP VIEW IF EXISTS PoorEarlier CASCADE;
DROP VIEW IF EXISTS PoorMaxDate CASCADE;
DROP VIEW IF EXISTS PoorRecent CASCADE;
DROP VIEW IF EXISTS PoorTotal CASCADE;
DROP VIEW IF EXISTS PoorPopulation CASCADE;
DROP VIEW IF EXISTS PoorProportion CASCADE;
DROP TABLE IF EXISTS EUNations CASCADE;
DROP VIEW IF EXISTS EUPoorTotal CASCADE;
DROP VIEW IF EXISTS EUPoorPopulation CASCADE;
DROP VIEW IF EXISTS EUPoorProportion CASCADE;
