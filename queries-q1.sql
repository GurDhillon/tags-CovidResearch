...
DROP VIEW IF EXISTS RecentDoses CASCADE;
DROP VIEW IF EXISTS TotalDoses CASCADE;
DROP VIEW IF EXISTS PercentDoses CASCADE;
DROP VIEW IF EXISTS PartScore CASCADE;
DROP VIEW IF EXISTS Score CASCADE;
DROP VIEW IF EXISTS ScoreGDP CASCADE;
DROP VIEW IF EXISTS q1 CASCADE;

DROP VIEW IF EXISTS PoorAvg CASCADE;
DROP VIEW IF EXISTS WealthyAvg CASCADE;
DROP VIEW IF EXISTS WealthyScores CASCADE;
DROP TABLE IF EXISTS EUNations CASCADE;
DROP VIEW IF EXISTS EUScores CASCADE;
DROP VIEW IF EXISTS NonEUScores CASCADE;
DROP VIEW IF EXISTS EUPoorAvg CASCADE;
DROP VIEW IF EXISTS NonEUPoorAvg CASCADE;
DROP VIEW IF EXISTS EUWealthyAvg CASCADE;
DROP VIEW IF EXISTS NonEUWealthyAvg CASCADE;
